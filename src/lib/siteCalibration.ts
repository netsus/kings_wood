...
export function latitudeDegreesToMeters(latitudeDegrees: number) {
  return latitudeDegrees * 111_320
}

export function longitudeDegreesToMeters(
  longitudeDegrees: number,
  latitude: number,
) {
  return longitudeDegrees * 111_320 * Math.cos((latitude * Math.PI) / 180)
}
